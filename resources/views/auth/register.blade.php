  ...
  <div class="flex justify-center">
    <div class="w-6/12 bg-white p-6 rounded-lg">
      <form action="{{ route('register') }}" method='post'> 
        ...
        <div class="mb-4">
          <label for="usermane" class="sr-only">Email</label>
        ...
        <div class="mb-4">
          ...
          <input type="text" name="password" id="password" placeholder="Password" class='bg-gray-100 border-2 w-full p-4 rounded-lg' value=''>
        </div>
